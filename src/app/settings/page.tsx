...
import type { Account, AppSettings, TelegramSettings } from "@/lib/types";
import { SettingsForm } from "./settings-form";
import { TelegramSettingsForm } from "./telegram-settings-form";
import { DefaultAccountForm } from "./default-account-form";

export const dynamic = "force-dynamic";

export default async function SettingsPage() {
  const [{ data }, { data: tg }, { data: accs }] = await Promise.all([
  ...
  return (
    <div className="mx-auto flex max-w-xl flex-col gap-6">
      ...
      <DefaultAccountForm accounts={accounts} defaultAccountId={settings?.default_account_id ?? null} />
      <SettingsForm
